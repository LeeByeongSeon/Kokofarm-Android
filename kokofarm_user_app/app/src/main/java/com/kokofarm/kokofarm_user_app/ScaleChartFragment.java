...
import com.kokofarm.kokofarm_user_app.databinding.FragmentScaleChartBinding;
...
import com.kokofarm.kokofarm_user_app.piece.ScaleCardView;
...
//            Log.e("avgJson", avgJson.toString());
            ...
            maker.makeTimeLineChart(avgJson,
                    new HashMap<String, String>() {{
                        put("awWeight", PageManager.getInstance().getRString(R.string.avg_weight));
                        put("refWeight", PageManager.getInstance().getRString(R.string.recommended_weight));
                    }});
            ...
            maker.makeTimeLineChart(ndisJson,
                    new HashMap<String, String>() {{
                        put("cnt", PageManager.getInstance().getRString(R.string.count));
                    }});
            maker.setMarker(context, R.layout.marker_text_view);
            chart.invalidate();
            ...
            maker.makeTimeLineChart(plusWeightJson,
                    new HashMap<String, String>() {{
                        put("diff", PageManager.getInstance().getRString(R.string.today_increase_weight));
                    }});
            maker.setMarker(context, R.layout.marker_text_view);
            chart.invalidate();
            ...
            maker.makeTimeLineChart(sensorJson,
                    new HashMap<String, String>() {{
                        put("cell_temp", PageManager.getInstance().getRString(R.string.temp_txt));
                        put("cell_humi", PageManager.getInstance().getRString(R.string.humi_txt));
//                        put("cell_co2", "이산화탄소");
//                        put("cell_nh3", "암모니아");
                    }});
            maker.setMarker(context, R.layout.marker_text_view);
